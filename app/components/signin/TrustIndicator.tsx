...
export const TrustIndicator = (
    {
        isDarkMode,
        isVisible,
    }: ITrustIndicatorProps
) => {
    const colors = getColors(isDarkMode)
    return (
        <div
            className={`flex items-center gap-4 pt-6 transition-all duration-500 delay-150 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
